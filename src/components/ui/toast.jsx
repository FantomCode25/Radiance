 ...
 * @property {any} [other] - All props accepted by ToastPrimitives.Root
 */

/**
 * @typedef {Object} ToastActionElement
 * @property {any} [other] - React element of ToastAction
 */
...
export const ToastActionElement = ToastAction;
