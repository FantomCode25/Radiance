      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <img 
                ...
                className="h-8 mr-2" 
              />
              <h3 className="text-xl font-medium">Mental Oasis</h3>
            </div>
            <p className="text-gray-300 mb-4">
              Providing accessible mental health care and wellness resources to help you thrive.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/quiz" className="text-gray-300 hover:text-white transition-colors">Mental Assessment</Link></li>
              <li><Link to="/therapists" className="text-gray-300 hover:text-white transition-colors">Find Therapists</Link></li>
              <li><Link to="/products" className="text-gray-300 hover:text-white transition-colors">Wellness Products</Link></li>
              <li><Link to="/blog" className="text-gray-300 hover:text-white transition-colors">Mental Health Blog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Therapist Resources</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} Mental Oasis. All rights reserved.
          </p>
